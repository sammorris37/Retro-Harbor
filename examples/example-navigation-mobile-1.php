...
<div class="grid-content example-container">
    ...
    <hr>
    <h6>Mobile Navigation Example 1</h6>
    <p>This example shows 3 levels of navigation with paged functionality. Click the burger nav icon to see the example.</p>
    ...
    <nav>
        ...
        <div class="navPage" data-nav-page="level-2-1">
            ...
            <ul class="menu-items">
                ...
                <li class="menu-item has-children" data-target="level-3-1">
                    <a href="javascript:void(0)" class="menu-link">Menu Item</a>
                </li>
            </ul>
        </div>
        <div class="navPage" data-nav-page="level-2-2">
            ...
            <ul class="menu-items">
                ...
                <li class="menu-item has-children" data-target="level-3-2">
                    <a href="javascript:void(0)" class="menu-link">Menu Item</a>
                </li>
            </ul>
        </div>
        <div class="navPage" data-nav-page="level-3-1">
            <a href="javascript:void(0)" class="backBtn" data-target="level-2-1">
            Back to Level 2
            </a>
            <ul class="menu-items">
                <li class="menu-item">
        ...
        <div class="navPage" data-nav-page="level-3-2">
            <a href="javascript:void(0)" class="backBtn" data-target="level-2-2">
            Back to Level 2
            </a>
            <ul class="menu-items">
                <li class="menu-item">
